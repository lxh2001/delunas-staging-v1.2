...
<html lang="en">
  ...
  <body>
    <main>
        @include('portals.admins.layouts.sidebar')

      <div class="content">
        <!-- Top Navigations -->
        @include('portals.admins.layouts.navbar');
    ...
    <div id="notificationBox" class="notification-box">
      ...
      {{-- <div class="notif-item">
        ...
        <p><span>Tony Stark</span>requesting to have an appointment with <span>Dra. Zenaida Delunas</span> for<span>Dental Filling/Pasta</span>on<span>October 22, 2023 -  11:30am.</span> Check your <a href="../admin/patient-appointment-logs.html">Patient Logs</a> now.
        </p>
      </div> --}}
      {{-- <div class="notif-item">
        <div class="notif-img-wrapper">
