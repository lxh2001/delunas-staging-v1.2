<div class="sidebar">
    ...
    <div class="links">
      <a href="{{ route('doctor.dashboard')}}"  class="{{ $isDashboardActive ?? '' }}"
        ><img src="{{ asset('icons/dashboard.png') }}" /> Dashboard</a
      >
      <a href="{{ route('doctor.appointment')}}" class="{{ $isMyAppointmentsActive ?? '' }}"
        ><img src="{{ asset('icons/calendar.png') }}" /> My Appointments</a
      >
      {{-- <a href="{{ route('doctor.my-profile')}}"  class="{{ $isMyProfileActive ?? '' }}">
        <img src="{{ asset('icons/accounts.png') }}" /> Profile
      </a> --}}
      <a href="{{ route('index') }}"
