@extends('portals.doctors.layouts.master', ['isMyAppointmentsActive' => 'active', 'title' => 'My Appointments'])

@section('content')
<div class="content-body"> <div class="custom-section mt-0"> <div class="d-flex flex-column w-100">
  <div class="header-title">
  <div>
  <h5>Appointments</h5>
  <p>Access your clients' appointment schedules.</p>
  </div>
</div>
...
@section('js')
<script src=" {{ asset('js/doctor-appointment.js') }}"> </script>
